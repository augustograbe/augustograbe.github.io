...
var turbineMatrixLocal = new Matrix4().setScale(2, 25, 2);
...
function handleKeyPress(event) {
  ...
  switch (ch) {
    ...
    case "t":
        joint.turbine += 15; 
        turbineMatrix.setTranslate(0, -5, 0).rotate(joint.turbine, 0, 1, 0);
        break;
    case "T":
        joint.turbine -= 15; 
        turbineMatrix.setTranslate(0, -5, 0).rotate(joint.turbine, 0, 1, 0);
    ...
    case "g":
        joint.generator += 15;
        generatorMatrix.setTranslate(0, 11, 0).rotate(joint.generator, 0, 1, 0);
        break;
    case "G":
        joint.generator -= 15; 
        generatorMatrix.setTranslate(0, 11, 0).rotate(joint.generator, 0, 1, 0);
    ...
    case "o":
        increment = 1;
        generatorMatrix.setTranslate(0, 11, 0);
        turbineMatrix.setTranslate(0, -5, 0);
        rotorMatrix.setTranslate(0, 0, 3);
        break;
    default:
      return;
  }
...
window.addEventListener("load", (event) => {
  ...
  (function animate() {
    ...
    if(!pause){
        rotorMatrix.rotate(increment, 0, 0, 1);
    } else{
